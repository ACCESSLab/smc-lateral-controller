...
#ifndef SMC_LATERAL_CONTROLLER__VEHICLE_MODEL__DYNAMIC_HPP_
#define SMC_LATERAL_CONTROLLER__VEHICLE_MODEL__DYNAMIC_HPP_
 ...
 */
class Dynamic : public Interface
{
public:
  /**
  ...
  std::string modelName() override {return "dynamic";}
...
#endif  // SMC_LATERAL_CONTROLLER__VEHICLE_MODEL__DYNAMIC_HPP_
