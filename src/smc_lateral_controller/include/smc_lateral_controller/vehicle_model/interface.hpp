...
#ifndef SMC_LATERAL_CONTROLLER__VEHICLE_MODEL__INTERFACE_HPP_
#define SMC_LATERAL_CONTROLLER__VEHICLE_MODEL__INTERFACE_HPP_
...
public:
   ...
   */
  Interface(int dim_x, int dim_u, int dim_y, double wheelbase);
  ...
  /**
   * @brief returns model name e.g. kinematic, dynamic
   */
  virtual std::string modelName() = 0;
};
}  // namespace autoware::motion::control::smc_lateral_controller
#endif  // SMC_LATERAL_CONTROLLER__VEHICLE_MODEL__INTERFACE_HPP_
